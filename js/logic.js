...
//https://earthquake.usgs.gov/data/comcat/data-eventterms.php#mag mag values [-1,10]
...
function createFeatures(earthquakeData) {
  ...
  var earthquakes = L.geoJSON(earthquakeData, {
      pointToLayer: function (dataP, latlng) {
          return L.circleMarker(latlng, { radius: markerSize(dataP.properties.mag) });
      },
